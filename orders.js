...
class Ticket {
    ...
    updateStatus(newStatus){
        ...
        console.log('The order for a customer',this.customerId,'is now',this.status)

    }
}
let customer1 = new Ticket ('sunglasees','12:55 am',3213213)
customer1.updateStatus('ready')
